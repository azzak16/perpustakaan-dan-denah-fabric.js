  ...
  <div class="col-md-12">
    <div class="panel">
      ...
      <div class="panel-body">
        <form action="{{route('pegawai.store')}}" method="POST">
          ...
          <div class="form-group">
            ...
            <input id="id_pegawai" name="id_pegawai" type="text" class="form-control" value="{{ $kode }}" readonly=""
              required>
          </div>
          {{-- <div class="form-group">
            <label for="kodep">Kodep</label>
            <input id="kodep" name="kodep" type="text" class="form-control" value="{{ $kodep }}" readonly="" required>
      </div> --}}
      ...
      <div class="form-group {{ $errors->has('tempat_lahir') ? ' has-error' : '' }}">
        ...
        <input id="tempat_lahir" name="tempat_lahir" type="text" value="{{ old('tempat_lahir') }}" class="form-control"
      ...
      <div class="modal-footer">
        ...
        <a href="{{route('pegawai.index')}}" type="button" class="btn btn-warning">Cancel</a>
      </div>
