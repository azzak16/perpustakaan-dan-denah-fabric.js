<nav class="navbar navbar-default navbar-fixed-top">
  <div class="brand">
    <a href="/"><img src="{{asset('/frontend')}}/img/pma.png" alt="Logo" class="img-responsive logo"></a>
  </div>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <img src="{{Auth::user()->getAvaptgs()}}" width="24x" height="24x" class="img-circle" alt="Avatar">
            @elseif(Auth::user()->role == 'user')
            <img src="{{Auth::user()->getAvauser()}}" width="24x" height="24x" class="img-circle" alt="Avatar">

            @else
            <img src="{{asset('images/admin.png')}}" width="24x" height="24x" class="img-circle" alt="Avatar">
            @endif
          ...
          <ul class="dropdown-menu">
            <li><a href="{{route('user.edit', Auth::user()->id)}}"><i class="lnr lnr-user"></i> <span>My
                  Profile</span></a></li>
